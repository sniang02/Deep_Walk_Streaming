...
class SkipGram(object):
    ...
    '''
    def __init__(self, window_size, embedding_size, whole_size, step_size=0.001, Theta=None):
        """
    ...
    def get_Nodes_and_Phis(self, ui_index):
        ...
        #Copy the embedding of the nodes
...
if __name__=='__main__':
    ...
    a, Phi=skipgram.get_Nodes_and_Phis(2)
    print(len(a))
    #print(skipgram.fracfunc(1, 2, Phi))
    skipgram.walk_train([1, 2, 3, 4, 5, 6, 7, 8], 2, False)
