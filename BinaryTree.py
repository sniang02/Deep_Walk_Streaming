...
class Node(object):
    ...
    def __init__(self, embedding_size):
        ...
        self.Phi=np.random.rand(embedding_size) # Embedding of the node.(have to be updated
...
class Tree(object):
    def __init__(self, whole_size, embedding_size):
        ...
        self.root = Node(self.embedding_size) #root of the tree
    ...
    def getNodeList(self, index):
       ...
       # print("seq = ", seq)
        prev=self.root
        binarySeq = bin(self.whole_size).lstrip('0b')
        self.layer_size = len(binarySeq)
       # print("taille :", self.layer_size)
